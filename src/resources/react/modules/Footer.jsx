...
const Footer = () => {
  ...
  location.includes("forgot-password")) return <></>

  return (
    <>
    <footer className="p-4 bg-white sm:p-6 shadow-sm border-t ">
      <div className="container">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com" className="flex items-center">
              <img src="" className="mr-3 h-8" alt="" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap">Mysite</span>
            </a>
          </div>
